            ...
            <article>
                <Card>
                    ...
                    <div style={{ position: "relative", height: "200px", width: "100%", overflow: "hidden" }}>
                        <Image src="/uploads/White_Oak_Quercus_alba_Tree_Bark_3264px.jpg" alt={data.item.title} key={data.item.imageLink} style={{ objectFit: "cover" }} placeholder="blur" fill={true} priority={true} />
                    </div>
                    <StyledBody>
